...
import {
  useGeneratePoemV3GeneratePoemV3Post,
  type PoemResponse,
  type PoemV3CreateRequest,
} from '../../../api';
...
const Version3 = () => {
  ...
  const { mutate } = useGeneratePoemV3GeneratePoemV3Post();
  ...
  const callApi = async (event?: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const body: PoemV3CreateRequest = {
      inputPoem: text,
    ...
    <Version versionName="Version 3">
      <div>
        <p>
          ...
          determined by using a fine-tuned version of GPT-4o-mini.
        </p>
        <div>
