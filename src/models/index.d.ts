...
export declare type PoemVariation = LazyLoading extends LazyLoadingDisabled ? EagerPoemVariation : LazyPoemVariation

export declare const PoemVariation: (new (init: ModelInit<PoemVariation>) => PoemVariation) & {
  copyOf(source: PoemVariation, mutator: (draft: MutableModel<PoemVariation>) => MutableModel<PoemVariation> | void): PoemVariation;
}